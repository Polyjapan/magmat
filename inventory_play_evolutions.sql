INSERT INTO inventory.play_evolutions (id, hash, applied_at, apply_script, revert_script, state, last_problem) VALUES (1, '8b5e2e05b0c4d0c03973e4785e1a9b03a4e2e251', '2019-11-30 17:00:22', 'create table events
(
...
on storage_location (room, space, location);', 'drop table object_logs;
...
drop table storage_location;', 'applied', 'Table ''events'' already exists [ERROR:1050, SQLSTATE:42S01]');